//TODO: delete these tests, should be tested throught behavioural approach 
//  Given, When, Then 
var expect = require('chai').expect;
var assert = require('chai').assert;
var spy = require('sinon').spy;
var Project = require('../../src/domain').Project;
...
describe('project aggregate root', function () {
    ...
    //TODO: remove when testing the commands  
    describe('change name', function () {
        ...
        before(function () {
            ...
            spy(project, 'changeName');
            spy(project, 'applyProjectNameChanged');
        ...
        describe('succeed', function () {
            ...
            it('apply project name changed event', function () {
                assert(project.applyProjectNameChanged.calledOnce);

                var evnt = project.applyProjectNameChanged.firstCall.args[0];
                expect(evnt.id).to.equal(id);
                expect(evnt.name).to.equal(name);
            });
